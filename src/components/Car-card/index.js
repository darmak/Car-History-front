                            ...
                            <div className="car-card-left">
                                ...
                                <div className="car-card-description">
                                    ...
                                    <div className="car-card-description-col">
                                        <Title level={5}>First service:<span className="car-counter">14/11/1996</span></Title>
                                        <Title level={5}>Last service:<span className="car-counter">14/11/1996</span></Title>
                                    </div>
                                </div>
                            </div>
                            <div className="car-card-info">
                                <Link to="/car-history">More...</Link>
                            </div>
                        </div>
                    </Card>
                </Col>
